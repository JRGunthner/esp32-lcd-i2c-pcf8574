...
void lcd_habilita_cursor(bool habilita) {
    lcd_i2c_config_cursor(lcd_info, habilita);
}

void lcd_cursor_piscar(bool habilita) {
    lcd_i2c_config_cursor_piscante(lcd_info, habilita);
}

void lcd_backlight(bool habilita) {
    lcd_i2c_backlight(lcd_info, habilita);
}
...
void lcd_habilita_display(bool habilita) {
    lcd_i2c_habilita_display(lcd_info, habilita);
}
...
void lcd_rolagem_automatica(bool habilita) {
    lcd_i2c_rolagem_automatica(lcd_info, habilita);
}
...
void lcd_caracter_personalizado(uint8_t indice, uint8_t* caracter) {
    lcd_i2c_caracter_personalizado(lcd_info, indice, caracter);
}
